...
const Card = ({ item, index }) => (
  <motion.div
    ...
    className="bg-white rounded-2xl border border-neutral-100 shadow-[0_4px_20px_rgba(0,0,0,0.05)] p-5 w-full max-w-sm"
  >
    <div className="flex items-center gap-3 mb-2">
      {/* Avatar placeholder - add your own image here */}
      <div className="w-9 h-9 rounded-full bg-neutral-200 shrink-0" />
      <p className="font-semibold text-neutral-900 text-sm">{item.name}</p>
    </div>
    <div className="flex gap-0.5 mb-3 text-blue-600">
...
const Client = () => {
  return (
    <section className="w-full bg-white py-14 sm:py-20 px-4 sm:px-8 md:px-12 lg:px-20">
